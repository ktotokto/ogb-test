...
const players = ref([
  { id: 1, name: 'Alex', role: 'creator', avatar: '1', status: 'online'},
  { id: 2, name: 'Maria', role: 'admin', avatar: '2', status: 'online'},
  { id: 3, name: 'John', role: 'guest', avatar: '3', status: 'away'},
  { id: 4, name: 'Kate', role: 'guest', avatar: '4', status: 'offline'}
])
